...
public class DoorScript : MonoBehaviour {
	...
	public class DoorControls
	{
        ...
        [Header("Random Generator Settings")][Space]public bool randomGhostJigle = false; public bool randomGhostClose = false;
        [Header("Random Close Jigle Wait")]
        [Range(60,300)]
        public float minCloseJigle = 60f;
        [Range(300, 1200)]
        public float maxCloseJigle = 120f;
    }
	[Serializable]
...
//--------------------------------
        ...
        StartCoroutine(RandomJigle());// Start random coroutine wait method
    }
	...
	IEnumerator RandomJigle()//random coroutine wait method
    {
        Debug.Log("Getting randumsum");
        randomSum = UnityEngine.Random.Range(controls.minCloseJigle,controls.maxCloseJigle);
        Debug.Log("Waiting randumsum");
        yield return new WaitForSeconds(randomSum);
        
        
           
            Debug.Log("Run Jigle Check");


        if (doorSounds.closed != null && Opened == false && inZone == false && controls.randomGhostJigle == true)
        {
            ...
            StartCoroutine(RandomJigle());

        }
        else if (Opened == true && inZone == false && controls.randomGhostClose == true)
        {
        ...
        {
            Debug.Log("Cant Run Jigle Check");
            Debug.Log("RestartCoroutine");//...............................................................................
            StartCoroutine(RandomJigle());
        }
